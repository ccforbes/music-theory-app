...
export const Staff: React.FC = () => {
    ...
    return <div className="staff">
        <svg width="1945" height="356" viewBox="0 0 1945 356" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <line id="B4" y1="171" x2="1945" y2="171" stroke="black" s1troke-width="4"/>
            ...
            <Note transformX={600} transformY={271} />
            <Note transformX={763} transformY={246} />
            <Note transformX={926} transformY={221} />
            <Note transformX={1089} transformY={196} />
            <Note transformX={1252} transformY={171} />
            <Note transformX={1415} transformY={146} />
            <Note transformX={1578} transformY={121} />
            <Note transformX={1741} transformY={96} />
        </svg>
        <Sharp />
